#!/usr/bin/env python3
# Credit: https://github.com/bioinf-jku/TTUR/blob/master/fid.py
...
def fid(real_images, fake_images):
    """
    Compute FID from a list of real and fake images
    :param real_images: numpy array of shape (n_sample, w, h, 3)
    :param fake_images: numpy array of shape (n_samples, w, h, 3
    :return: Fréchet inception distance on the images
    """
    print("Computing FID:")
    ...
    with tf.compat.v1.Session() as sess:
        ...
        mu1, sigma1 = calculate_activation_statistics(real_images, sess)
        mu2, sigma2 = calculate_activation_statistics(fake_images, sess)
